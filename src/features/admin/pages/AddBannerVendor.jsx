...
export default function AddBannerForm() {
  ...
  const { data: venuelist, isLoading: venueloading } = useFetchVendorVenueList(selectedVendorId);
    ...
    <div className="banner-form-container">
      ...
      >
        <div className='form-row'>
          ...
          <Form.Item label="Venue ID" name="venueId" rules={[{ required: true }]}>
            <Select
              showSearch
              ...
              allowClear
              onChange={(value) => {
                const selectedVenue = venuelist?.result?.find(v => v.id === value);
                form.setFieldsValue({
        ...
        <div className="form-row">
          <Form.Item label="Radius in KM" name="radius" rules={[{ required: true }]}>
        ...
        <Form.Item style={{ textAlign: 'center' }}>
          <Button loading={loading} type="primary" htmlType="submit" className="submit-btn" >
