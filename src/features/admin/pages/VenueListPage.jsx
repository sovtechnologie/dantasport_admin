...
export default function VenuePage() {
    ...
    // status change
    const { mutate: venueStatus, isloading: statusloading } = useUpdateVenueStatus();
            ...
            <Spin spinning={isLoading} size="large" >
                ...
                <div className="venue-page-container">
                    <div className="venue-header-form">
                        <Button type="primary" icon={<PlusOutlined />} className="add-venue-button" onClick={handleAddVendor}>
                            Add Venue
                        </Button>
                    </div>
