...
export default function AddSport() {
    ...
    const handleApply = () => {
        if (!slots.Monday.length) return message.warning("No Monday slots to apply.");
        if (!applyToDays.length) return message.warning("Select weekdays to apply.");
        ...
        <div className="add-sport-container">
            ...
            >
                ...
                <div className="form-submit-btn">
                    <Form.Item>
                        <Button type="primary" className="update-btn" htmlType="submit" loading={loading}>Update Time and Price</Button>
                    </Form.Item>
                </div>
            </Form>
        </div>
