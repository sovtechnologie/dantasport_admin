...
export default function AddCoupon() {
    ...
    const onFinish = async (values) => {
        try {
            ...
            message.error(error.message || "Failed to create discount coupon. Please try again.");
        } finally {
            ...
            <div className="coupon-header-compact">
                <div className="header-left">
                    ...
                    <div className="header-title">
                        ...
                        <Title level={3} className="coupon-title-compact">Add Discount Coupon</Title>
                    </div>
                </div>
                ...
                >
                    ...
                    <div className="form-actions-compact">
                        <Button 
                            ...
                            block
                        >
                            {isSubmitting || createCouponMutation.isPending ? 'Creating Coupon...' : 'Create Discount Coupon'}
                        </Button>
                    </div>
                </Form>
            </Card>
