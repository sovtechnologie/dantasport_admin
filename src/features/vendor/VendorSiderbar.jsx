      ...
      <nav className="sidebar-nav">
        <ul>
          ...
          <li>
            ...
            <ul
              className={`sidebar-submenu ${openMenus.reports ? "open" : ""}`}
            >
              <li>
                <Link
                  to="/vendor/reports/booking"
                  className={`sidebar-submenu-item ${
                    isActive("/vendor/reports/booking") ? "active" : ""
                  }`}
              ...
              <li>
                <Link
                  ...
                  className={`sidebar-submenu-item ${
                    isActive("/vendor/reports/coupan") ? "active" : ""
                  }`}
                  onClick={() => onSelect("Reports")}
                >
                  <GiftOutlined className="sidebar-menu-icon" />
          ...
          <li>
            <Link
              to="/vendor/reviews"
              className={`sidebar-menu-item ${
                isActive("/vendor/reviews") ? "active" : ""
              }`}
          ...
          <li>
            ...
            <ul
              className={`sidebar-submenu ${openMenus.runEvent ? "open" : ""}`}
            >
              <li>
                <Link
                  to="/vendor/runEvent/basicInfo"
                  className={`sidebar-submenu-item ${
                    isActive("/vendor/runEvent/basicInfo") ? "active" : ""
                  }`}
              ...
              <li>
                <Link
                  ...
                  className={`sidebar-submenu-item ${
                    isActive("/vendor/runEvent/communication") ? "active" : ""
                  }`}
                  onClick={() => onSelect("Run/Event")}
                >
              ...
              <li>
                <Link
                  ...
                  className={`sidebar-submenu-item ${
                    isActive("/vendor/runEvent/booking") ? "active" : ""
                  }`}
                  onClick={() => onSelect("Run/Event")}
                >
                  <CalendarOutlined className="sidebar-menu-icon" />
              ...
              <li>
                ...
                <ul
                  className={`sidebar-nested-submenu ${
                    openMenus.eventReport ? "open" : ""
                  }`}
                >
                  <li>
                    <Link
                      to="/vendor/runEvent/reports/revenue"
                      className={`sidebar-nested-submenu-item ${
                        isActive("/vendor/runEvent/reports/revenue")
                          ? "active"
                          : ""
                      }`}
                    >
                  ...
                  <li>
                    <Link
                      ...
                      className={`sidebar-nested-submenu-item ${
                        isActive("/vendor/runEvent/reports/rating")
                          ? "active"
                          : ""
                      }`}
                    >
                  ...
                  <li>
                    <Link
                      ...
                      className={`sidebar-nested-submenu-item ${
                        isActive("/vendor/runEvent/reports/coupan")
                          ? "active"
                          : ""
                      }`}
                    >
              ...
              <li>
                <Link
                  ...
                  className={`sidebar-submenu-item ${
                    isActive("/vendor/runEvent/member") ? "active" : ""
                  }`}
                  onClick={() => onSelect("Run/Event")}
                >
                  <TeamOutlined className="sidebar-menu-icon" />
              ...
              <li>
                <Link
                  ...
                  className={`sidebar-submenu-item ${
                    isActive("/vendor/runEvent/images") ? "active" : ""
                  }`}
                  onClick={() => onSelect("Run/Event")}
                >
                  <CameraOutlined className="sidebar-menu-icon" />
            ...
            <ul className={`sidebar-submenu ${openMenus.gym ? "open" : ""}`}>
              ...
              <li>
                <Link
                  ...
                  className={`sidebar-submenu-item ${
                    isActive("/vendor/gym/control") ? "active" : ""
                  }`}
                  onClick={() => onSelect("Gym")}
                >
