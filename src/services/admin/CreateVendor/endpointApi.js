...
export const VendorOtpVerification = async (payload) => {
    try {
        const response = await api.post("admin/vendors/vendorOtpVerification", payload);
        return response?.data;
    } catch (error) {
...
export const AddVendorBankingDetails = async (payload) => {
    try {
        const response = await api.post("admin/vendors/addVendorBankingDetails", payload);
        return response?.data;
    } catch (error) {
...
export const VendorRequestUpdateDetailsOtp = async (payload) => {
    try {
        const response = await api.post("admin/vendors/requestUpdateVendorDetailsOtp", payload);
        return response?.data;
    } catch (error) {
...
export const UpdateVendorDetailsWithOtp = async (payload) => {
    try {
        const response = await api.post("admin/vendors/updateVendorDetailsWithOtp", payload);
        return response?.data;
    } catch (error) {
