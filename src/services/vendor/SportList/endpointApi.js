...
export const fetchSportVenueList = async (payload) => {
  try {
    const response = await api.post(
      "vendor/sports/getSportsListVendor",
      payload
    );
...
export const getSportsListByCategory = async (payload) => {
  try {
    const response = await api.post(
      "vendor/sports/getSportsListByCategory",
      payload
    );
    return response.data;
  } catch (error) {
...
export const getVendorSportsList = async (payload) => {
  try {
    const response = await api.post(
      "vendor/court/getVendorSportsList",
      payload
    );
    return response.data;
  } catch (error) {
...
export const getSingleVendorSports = async (payload) => {
  try {
    const response = await api.post(
      "vendor/sports/getSingleVendorSports",
      payload
    );
    return response.data;
  } catch (error) {
    console.error("Error fetching single vendor sport:", error);
    throw error;
  }
};
