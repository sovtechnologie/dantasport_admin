...
const VendorServiceSelect = lazy(() => import("../features/vendor/Component/VendorServiceSelect.jsx"));

// Vendor routes
const VendorBookingPage = lazy(() => import('../features/vendor/pages/ReportPage/BookingPage'));
const VenManBasicInfo = lazy(() => import("../features/vendor/pages/ManagePage/BasicInfo"));
const VenuManVenueList = lazy(() => import("../features/vendor/pages/ManagePage/VenueList.jsx"));
const VenManVendorInfo = lazy(() => import("../features/vendor/pages/ManagePage/VendorInfo"));
const VenManSports = lazy(() => import("../features/vendor/pages/ManagePage/Sports"));
const VenManAddSport = lazy(() => import("../features/vendor/pages/ManagePage/addSport"));
const VenManEditSport = lazy(() => import("../features/vendor/pages/ManagePage/EditSport.jsx"));
const VenManCourt = lazy(() => import("../features/vendor/pages/ManagePage/Court"));
const VenManAddCourt = lazy(() => import("../features/vendor/pages/ManagePage/addCourt"));
const VenManImages = lazy(() => import("../features/vendor/pages/ManagePage/Images"));
const VenManAddImages = lazy(() => import("../features/vendor/pages/ManagePage/addGallery"))
const VenManSlots = lazy(() => import("../features/vendor/pages/ManagePage/SlotPricing"));
const VenManMember = lazy(() => import("../features/vendor/pages/ManagePage/Member"));
const VenManAddMember = lazy(() => import("../features/vendor/pages/ManagePage/addMember"));
const VenManDiscount = lazy(() => import("../features/vendor/pages/ManagePage/Discount"));
const VenManAddDiscount = lazy(() => import("../features/vendor/pages/ManagePage/addCoupan"));
const VenManEditDiscount = lazy(() => import("../features/vendor/pages/ManagePage/EditCoupon"));
const VenDaySlots = lazy(() => import("../features/vendor/pages/Dayslot/DaySlots"));
const BookedDetails = lazy(() => import("../features/vendor/pages/Dayslot/BookedSlots"));
const AvailableDetails = lazy(() => import("../features/vendor/pages/Dayslot/AvailableSlots"));
...
const VendorEnquiry = lazy(() => import("../features/admin/pages/Enquires/VendorEnquiry"))
const VendorListPage = lazy(() => import("../features/admin/pages/VendorListPage"));
const AddVendor = lazy(() => import("../features/admin/pages/AddVendor"));
const EditVendor = lazy(() => import("../features/admin/pages/EditVendorDetails.jsx"))
const VenueListPage = lazy(() => import("../features/admin/pages/VenueListPage"));
const AddVenue = lazy(() => import("../features/admin/pages/AddVenue"));
const EditVenue = lazy(() => import("../features/admin/pages/EditVenueDetails.jsx"))
const AddBannerAdmin = lazy(() => import("../features/admin/pages/AddBannerAdmin"));
const AddBannerVendor = lazy(() => import("../features/admin/pages/AddBannerVendor"));
const SportsPage = lazy(() => import("../features/admin/pages/Services/Sports"));
const RunEventPage = lazy(() => import("../features/admin/pages/Services/Run_Event"));
const HostPlayPage = lazy(() => import("../features/admin/pages/Services/Host_Play"));
const GymPage = lazy(() => import("../features/admin/pages/Services/Gym"));
const CoachPage = lazy(() => import("../features/admin/pages/Services/Coaching"));
...
const AppRoutes = () => {
  ...
  return (
    <Suspense fallback={<div style={{ display: "flex", justifyContent: "center", alignItems: "center", marginTop: "50vh" }}> <Spin size='large'></Spin></div>}>
      <Routes>
        ...
        <Route element={<ProtectedRoute allowedRole="admin" />}>
          <Route path="/admin" element={<AdminLayout />}>
            ...
            <Route path="/admin/vendors/edit-vendor/:id" element={<EditVendor />} />
            {/* Venue */}
            <Route path="/admin/venues" element={<VenueListPage />} />
            <Route path="/admin/venues/add-venue" element={<AddVenue />} />
            <Route path="/admin/venues/edit-venue/:id" element={<EditVenue />} />
            {/* Banners */}
        ...
        <Route element={<ProtectedRoute allowedRole="vendor" />}>
          <Route path="/vendor" element={<VendorLayout />}>
            ...
            {/* Manage Routes */}
            <Route path='/vendor/manage/basic-info' element={<VenManBasicInfo />} />
            <Route path='/vendor/manage/venuelist' element={<VenuManVenueList />} />
            <Route path='/vendor/manage/editvenue/:id' element={<VenManVendorInfo />} />
            <Route path='/vendor/manage/sports' element={<VenManSports />} />
            <Route path='/vendor/manage/addsport' element={<VenManAddSport />} />
            <Route path='/vendor/manage/editsport/:id' element={<VenManEditSport />} />
            <Route path='/vendor/manage/court' element={<VenManCourt />} />
            <Route path='/vendor/manage/addcourt' element={< VenManAddCourt />} />
            <Route path='/vendor/manage/images' element={<VenManImages />} />
            <Route path="/vendor/manage/addImages" element={<VenManAddImages />} />
            <Route path='/vendor/manage/slotpricing' element={<VenManSlots />} />
            <Route path='/vendor/manage/member' element={<VenManMember />} />
            <Route path='/vendor/manage/addmember' element={<VenManAddMember />} />
            <Route path='/vendor/manage/discount' element={<VenManDiscount />} />
            <Route path='/vendor/manage/adddiscount' element={<VenManAddDiscount />} />
            <Route path='/vendor/manage/editcoupon' element={<VenManEditDiscount />} />
            {/* DaySlots routes */}
